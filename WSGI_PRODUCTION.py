...
# ==========================================
# SERVIR ARQUIVOS ESTÁTICOS DO TASKFLOWAI
# ==========================================

@application.route('/taskflowai/static/<path:path>')
def taskflowai_static(path):
    """
    Serve arquivos estáticos do TaskFlowAI (CSS, JS, imagens)
    """
    from flask import send_from_directory
    static_path = '/home/lobtechsolutions/TaskFlowAI/taskflowai/static'
    return send_from_directory(static_path, path)
